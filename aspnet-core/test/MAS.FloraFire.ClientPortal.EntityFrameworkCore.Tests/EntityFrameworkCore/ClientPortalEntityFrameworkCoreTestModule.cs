...
[DependsOn(
    typeof(ClientPortalApplicationTestModule),
    typeof(ClientPortalEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class ClientPortalEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        using (var context = new ClientPortalDbContext(options))
        {
