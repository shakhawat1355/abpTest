...
public static partial class ISO3166
{
    ...
    public static IEnumerable<ISO3166Country> GetCollection()
    {
        ...
        return new[] {
            ...
            new ISO3166Country("Czechia", "CZ", "CZE", 203, new[] { "420" }),
            ...
            new ISO3166Country("Guernsey", "GG", "GGY", 831, new[] { "44" }),
            ...
            new ISO3166Country("Isle of Man", "IM", "IMN", 833, new[] { "44" }),
            ...
            new ISO3166Country("Jersey", "JE", "JEY", 832, new[] { "44" }),
            ...
            new ISO3166Country("Puerto Rico", "PR", "PRI", 630, new[] { "1" }),
            ...
            new ISO3166Country("San Marino", "SM", "SMR", 674, new[] { "378" }),
